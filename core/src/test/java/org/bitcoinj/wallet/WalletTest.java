...
public class WalletTest extends TestWithWallet {
    ...
    // identical result to LifetionCoin Core. However the signatures are not deterministic - signing the same data
    ...
    public void blockChainCatchup() throws Exception {
        ...
        // What we'd really like to do is prove LifetionCoin Core would accept it .... no such luck unfortunately.
