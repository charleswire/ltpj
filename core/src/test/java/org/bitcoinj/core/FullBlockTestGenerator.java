 ...
 *    LifetionCoin Core consensus rules a shared library and use that. Seriously, you wont get it right, and starting with
 *    this tester as a way to try to do so will simply end in pain and lost coins. SERIOUSLY, JUST STOP!
 *
 * b) LifetionCoin Core is failing some test in here and you're wondering what test is causing failure. Just stop. There is no
