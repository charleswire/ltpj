...
public class GovernanceVoteBroadcast {
    ...
    private class EnoughAvailablePeers implements Runnable {
        ...
        public void run() {
            ...
            // LifetionCoin Core sends an inv in this case and then lets the peer request the vote data. We just
            // blast out the TX here for a couple of reasons. Firstly it's simpler: in the case where we have
            // just a single connection we don't have to wait for getdata to be received and handled before
            // completing the future in the code immediately below. Secondly, it's faster. The reason the
            // LifetionCoin Core sends an inv is privacy - it means you can't tell if the peer originated the
