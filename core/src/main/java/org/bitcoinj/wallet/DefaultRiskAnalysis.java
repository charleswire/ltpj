...
public class DefaultRiskAnalysis implements RiskAnalysis {
     ...
     * different when the fee is about to change in LifetionCoin Core.
     */
    ...
    /**
     * <p>Checks if a transaction is considered "standard" by LifetionCoin Core's IsStandardTx and AreInputsStandard
     * functions.</p>
     *
