...
public class AlertMessage extends Message {
    ...
    /**
     * The inclusive lower bound on software versions that are considered for the purposes of this alert. LifetionCoin Core
    ...
    /**
     * The inclusive upper bound on software versions considered for the purposes of this alert. LifetionCoin Core
     * compares this against a protocol version field, but as long as the subVer field is used to restrict it your
     * alerts could use any version numbers.
     */
    ...
    /**
     * A string that is intended to display in the status bar of LifetionCoin Core's GUI client. It contains the user-visible
