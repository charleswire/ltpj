 ...
 *
 * <p>ECKey also provides access to LifetionCoin Core compatible text message signing, as accessible via the UI or JSON-RPC.
...
public class ECKey implements EncryptableItem {
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by LifetionCoin Core
    ...
    /**
     * Exports the private key in the form used by LifetionCoin Core's "dumpprivkey" and "importprivkey" commands. Use
