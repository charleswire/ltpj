...
public class VersionMessage extends Message {
     ...
     * LifetionCoin Core sets it to something like "/Satoshi:0.9.1/".
     */
    ...
    public static final String BITCOINJ_VERSION = "1.0.0-SNAPSHOT";
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        // Note that the LifetionCoin Core doesn't do anything with these, and finding out your own external IP address
