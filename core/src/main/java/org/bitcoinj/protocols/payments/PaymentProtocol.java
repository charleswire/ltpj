...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/lifetioncoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/lifetioncoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/lifetioncoin-paymentack";
